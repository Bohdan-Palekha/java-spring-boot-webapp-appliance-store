...
class EmployeeTest extends ReflectionTestBase {

    @BeforeAll
    static void setup() throws ClassNotFoundException {
        init(TestConstants.EMPLOYEE_TYPE);
    }
    ...
    @Test
    @DisplayName("Field 'department' of type String")
    void checkDepartmentField() {
        assertFieldExists("department", TestConstants.STRING_TYPE);
    }
    ...
    void checkParameterTypes() {
        ...
        assertEquals(1, countParamsByType(c, TestConstants.LONG_TYPE));
        assertEquals(4, countParamsByType(c, TestConstants.STRING_TYPE));
    }
}
